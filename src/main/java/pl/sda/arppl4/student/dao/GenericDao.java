package pl.sda.arppl4.student.dao;
...
import pl.sda.arppl4.student.util.HibernateUtil;
...
import java.util.Optional;
    ...
    public class GenericDao<T> {
        ...
        public List<T> list(Class<T> classType) {
            ...
            SessionFactory fabrykaPolaczen = HibernateUtil.getSessionFactory();
            try (Session session = fabrykaPolaczen.openSession()) {
                TypedQuery<T> zapytanie = (TypedQuery<T>) session.createQuery("from " + classType.getName(), classType);
